...
public class EditBoardController {
	...
	public String boardInsert(
		...
		// 게시글 작성(INSERT) 성공 시 -> 작성된 글 상세조회로 redirect
	...
	public String boardDelete(
		...
		int result = service.boardDelete(boardCode, boardNo);
		
		String path = null;
		
		if(result > 0) {
			
			path = "redirect:/board/" + String.valueOf(boardCode);
			
		} else {
			
			path = "redirect:/board/" + String.valueOf(boardCode) + String.valueOf(boardNo);
		}

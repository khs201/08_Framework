...
@Controller // 요청/응답 제어 역할 + Bean에 등록
@RequestMapping("param") // param으로 시작하는 요청을 현재 컨트롤러 클래스로 매핑
...
public class ParameterController {
	...
	public String paramMain() {
		...
		// return "/src/main/resources/templates/param-main.html";
	...
	public String paramTest3(
		...
		// @RequestParam Map<String, Objecet>
		// -> 제출된 모든 파라미터가 Map에 저장된다!!!!!
		// -> 문제점 : key(name속성값)값이 중복되면 덮어쓰기가 된다!!!!
